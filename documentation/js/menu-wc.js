                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/PifHeaderComponent.html" data-type="entity-link" >PifHeaderComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/TimeDataTypeComponent.html" data-type="entity-link" >TimeDataTypeComponent</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/MockDraftService.html" data-type="entity-link" >MockDraftService</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/IDraftService.html" data-type="entity-link" >IDraftService</a>
                            </li>
                            <li class="link">
